"""Explicit encounter command; observed scene geometry never decides the action."""
...
class ActionRequestCommand(EvaluationBankCommand):
...
class ActionRequestEnvCfg(EvaluationBankEnvCfg):
    def __init__(self, config, **kwargs):
        super().__init__(config, **kwargs)
        self.commands.motion.class_type = ActionRequestCommand
...
class ActionRequestRecorder(EvaluationBankRecorder):
...
@configclass
class ActionRequestRecorderCfg(EvaluationBankRecorderCfg):
    class_type = ActionRequestRecorder
