#!/usr/bin/env python3
"""Registered distinct-output analytic solver at the learned pattern query budget."""
...
def main():
    ...
    for name, case in cases.items():
        ...
        trace["duplicate_selected"] = trace["selected"]
        trace["selected"] = distinct_indices(trace)
