...
ALLOWED = [Path(__file__).resolve().parent, DATA / 'm2s-acquisition-M2-portable-20260909-v1', *map(Path, site.getsitepackages())]
IMMUTABLE = [DATA / 'm2s-acquisition-M2-portable-20260909-v1', Path(__file__).resolve().parent / 'toolkit_readonly_v3']
