...
body = re.sub(
    r'(<p><a class="figure".*?</a></p>\s*<p class="caption">.*?</p>)',
...
<title>Motion2Scene — Detailed research methods — revised architecture atlas</title>
<style>
...
<a href="methods_draft.md">Editable draft</a><a href="fig0_research_overview.svg">Overview SVG</a>
<a href="fig2_teacher_full_command.svg">Architecture SVG</a>
<a href="fig1_hindsight_generator.svg">Scene illustration SVG</a></nav>
