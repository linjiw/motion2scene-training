> **Superseded September 11:** use the [pilot boundary audit](../audit/20260911-pilot-boundary/README.md) and revised `traversal_method_v2` manuscript. The following audit describes a historical package.
